...
class Knight(Piece):
    def get_possible_moves(self, game_state):
        """
        Calculates all possible moves for the knight based on its movement pattern.

        Args:
            game_state: The current state of the chess game.

        Returns:
            A list of tuples representing the possible moves as (row, column) coordinates.
        """
        _moves = []
    ...
    def get_valid_peaceful_moves(self, game_state):
        """
        Calculates the valid peaceful moves for the knight.

        Args:
            game_state: The current state of the chess game.

        Returns:
            A list of tuples representing the valid peaceful moves as (row, column) coordinates.
        """
        _moves = []
        for new_row, new_col in self.get_possible_moves(game_state):
    ...
    def get_valid_piece_takes(self, game_state):
        """
        Calculates the valid moves for the knight that capture opponent pieces.

        Args:
            game_state: The current state of the chess game.

        Returns:
            A list of tuples representing the valid moves that capture opponent pieces
